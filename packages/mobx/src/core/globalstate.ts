...
export class MobXGlobals {
    ...
    /**
     * 当前运行的反应。这决定了我们当前是否有一个反应上下文。
     * (跟踪派生也被设置为对动作内部计算值的时间跟踪，但trackingReaction只能通过一种形式的Reaction来设置)
    ...
    /**
     * Is it allowed to read observables at this point?  在这一点上是否允许读取可观察对象?
    ...
    /**
     * (Experimental)
     * Warn if observables are accessed outside a reactive context 如果在响应上下文之外访问了observable，则发出警告
     */
